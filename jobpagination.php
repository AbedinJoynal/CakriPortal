		...
		$sql1 = "SELECT * FROM company WHERE id_company='$row[id_company]'";
		   ...
		   <div class="attachment-block clearfix">
              ...
              <div class="attachment-pushed">
                <h4 class="attachment-heading"><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle']; ?></a> <span class="attachment-heading pull-right">Tk.<?php echo $row['maximumsalary']; ?>/Month</span></h4>
