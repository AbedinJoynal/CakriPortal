        ...
        <div class="login-box-body">
            ...
            <form method="post" action="checkcompanylogin.php">
                ...
                <div class="row">
                    ...
                    <a style="margin:4.8rem !important;" href="./register-company.php">Haven't company? Register</a>
                    <!-- /.col -->
                    <div class="col-xs-12">
                        <?php
            ...
            ?>
                        <div>
                            <p class="text-center">You Have Registered Successfully! Your Account Approval Is Pending By
                                Admin</p>
                        </div>
                        <?php
